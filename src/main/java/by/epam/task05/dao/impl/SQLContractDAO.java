...
public class SQLContractDAO extends SqlDao implements ContractDAO {
    ...
    public int addContract(Contract contract) throws DaoException {
        ...
        try {
            ...
            try{
                java.util.Date date1 = sdf1.parse(contract.getDate_start());
                java.util.Date date2 = sdf1.parse(contract.getDate_finish());
                st.setDate(7, new java.sql.Date(date1.getTime()));
                st.setDate(8, new java.sql.Date(date2.getTime()));
            }
            catch (Exception e)
            {
    ...
    private Contract createContract(ResultSet resultSet) throws SQLException {
        ...
        java.util.Date date1 = resultSet.getDate(7);
        java.util.Date date2 = resultSet.getDate(8);
        String date_start = df.format(date1);
        String date_finish = df.format(date2);
        ...
        contract.setDate_start(date_start);
        contract.setDate_finish(date_finish);
