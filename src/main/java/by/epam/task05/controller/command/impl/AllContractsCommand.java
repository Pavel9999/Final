...
public class AllContractsCommand implements Command
{
    public static final String COMMAND = "all_contracts";

    private static final String ADMIN_CONTRACTS_PAGE = "/WEB-INF/views/admin_contracts.jsp";
