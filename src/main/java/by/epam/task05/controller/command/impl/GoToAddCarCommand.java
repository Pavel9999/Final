...
public class GoToAddCarCommand implements Command {

    public static final String COMMAND = "go_to_add_car";

    private static final String ADD_CAR_PAGE = "/WEB-INF/views/add_car.jsp";
