...
public class ContractServiceImpl implements ContractService {
    ...
    @Override
    public List<ContractData> selectAllContracts() throws DaoException {
        List<ContractData> contractDatas = new LinkedList<>();

        DAOProvider daoProvider = DAOProvider.getInstance();
        ContractDAO contractDAO = daoProvider.getContractDAO();

        List<Contract> contracts = contractDAO.selectAllContracts();
    ...
    @Override
    public boolean startRent(int id_user, int id_car, String date_start, String date_finish) throws DaoException {
        DAOProvider daoProvider = DAOProvider.getInstance();
    ...
    private ContractData createContractData(Contract contract) throws DaoException {
        ...
        contractData.setId_car(contract.getId_car());
