...
public interface ContractService {
    ...
    List<ContractData> selectAllContracts() throws DaoException;
    ...
    boolean startRent(int id_user, int id_car, String date_start, String date_finish) throws DaoException;
