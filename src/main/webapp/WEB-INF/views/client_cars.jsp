    ...
    <div class="subnav">
        <button class="subnavbtn">
            <form action="/controller" method="POST">
                ...
                <input style="border:0; color:white; background-color: transparent;" type="submit" value="${rented_cars_text}" />
            </form>
        </button>
    </div>
                ...
                <c:if test = "${car_collumn.contract_id == 0}">
                    <button class="btn">
                        ...
                        <form action="/controller" method="POST">
                            ...
                            <input type="hidden"  name="car_id" value="${car_collumn.id}" />

                            <label for="date">дата c</label>
                            <input type="date" value="${date_start_fill}" id="date" name="date_start" />
                            <label for="date">дата по</label>
                            <input type="date" value="${date_finish_fill}" id="date" name="date_finish" />

                            <input style="border:0; color:white; background-color: transparent;" type="submit" value="${rent_car_text}" />
                        </form>
                    </button>
