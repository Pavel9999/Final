...
<head>
    ...
    <fmt:message bundle="${loc}" key="local.add_car"
                 var="add_car_text" />
...
<form action="/controller" method="POST">
    ...
    <table style="with: 50%">
        <tr>
            <td>Brand</td>
            <td><input type="text" name="brand" value="${brand_fill}"  /></td>
        </tr>
        <tr>
            <td>Model</td>
            <td><input type="text" name="model" value="${model_fill}"/></td>
        </tr>
        <tr>
            <td>Image</td>
            <td><input type="text" name="img" value="${img_fill}"/></td>
        </tr>
        <tr>
            <td>Color</td>
            <td><input type="text" name="color" value="${color_fill}"/></td>
        </tr>
        <tr>
            <td>Year</td>
            <td><input type="text" name="year" value="${year_fill}"/></td>
        </tr>
        <tr>
            <td>Price</td>
            <td><input type="text" name="price" value="${price_fill}"/></td>
        </tr>
    </table>
    <input type="submit" value="${add_car_text}" />
</form>
